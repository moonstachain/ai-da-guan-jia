...
REQUIRED_FILES = [
    ...
    ROOT / "references" / "governance-review-contract.md",
    ...
    ROOT / "references" / "strategic-governor-contract.md",
    ROOT / "references" / "autonomy-proposal-contract.md",
    ROOT / "references" / "incentive-scorecard-contract.md",
    ROOT / "references" / "feishu-review-base-schema.json",
    ROOT / "references" / "feishu-review-sync-contract.md",
    ROOT / "references" / "feishu-governance-base-schema.json",
    ROOT / "references" / "feishu-governance-sync-contract.md",
...
def check_entrypoints(errors: list[str]) -> None:
    for command in (
        ...
        ["python3", str(MAIN_SCRIPT), "bootstrap-hub", "--help"],
        ["python3", str(MAIN_SCRIPT), "emit-intake-bundle", "--help"],
        ["python3", str(MAIN_SCRIPT), "aggregate-hub", "--help"],
        ["python3", str(MAIN_SCRIPT), "audit-maturity", "--help"],
        ["python3", str(MAIN_SCRIPT), "review-skills", "--help"],
        ["python3", str(MAIN_SCRIPT), "review-governance", "--help"],
        ["python3", str(MAIN_SCRIPT), "strategy-governor", "--help"],
